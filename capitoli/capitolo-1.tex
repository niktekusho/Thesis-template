...
Un esempio lampante di dispositivi \emph{smart} sono gli smartphone, prodotti che hanno arricchito di funzionalità cosìdette "intelligenti" i predecessori telefoni (\emph{phone}).
...
La \emph{containerization} è un metodo di virtualizzazione posto al livello del sistema operativo per la distribuzione ed esecuzione di applicazioni. Ogni container è un'istanza di 
