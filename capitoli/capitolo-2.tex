...
L'obiettivo "OT6" è strettamente correlato con l'obiettivo "OT3", il quale richiede l'utilizzo di tecnologie multi-piattaforma per la corretta esecuzione del prototipo. Ho scelto di vincolare lo sviluppo del prototipo adottando \emph{Node.js} come \emph{framework} per l'implementazione della parte \emph{backend} per due motivi:
\begin{enumerate}
