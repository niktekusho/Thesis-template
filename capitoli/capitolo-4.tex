...
\footnotetext{
\begin{itemize}
	\item[] Tabella di compatibilità dei \emph{browser}: \url{http://kangax.github.io/compat-table/es2016plus/}
	\item[] Tabella di compatibilità di Node.js: \url{http://node.green/\#ES2017}
\end{itemize}}
