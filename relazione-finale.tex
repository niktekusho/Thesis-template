...
\usepackage[toc, acronym, translate=babel]{glossaries}   % glossario
...
\input{relazione-finale-config}                     % file con le impostazioni personali
...
\input{inizio-fine/convenzioni-tipografiche}
